...
class QueryBuilder(http.Controller):
    ...
    def source_data(self, fields, model, start_date=None, end_date=None):
        return self.get_query(fields, model, start_date, end_date)

    def get_query(self, fields, model, start_date=None, end_date=None):
        results = []
        table = model['model'].replace('.', '_')
        if start_date and end_date:
            ...
            domain = []
        search = request.env[model['model']].search(domain)
